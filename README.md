# @zitterorg/officiis-eveniet [![](http://img.shields.io/npm/dm/@zitterorg/officiis-eveniet.svg?style=flat)](https://www.npmjs.org/package/@zitterorg/officiis-eveniet) [![Node.js CI](https://github.com/zitterorg/officiis-eveniet/actions/workflows/node.js.yml/badge.svg)](https://github.com/zitterorg/officiis-eveniet/actions/workflows/node.js.yml)

> Simple to use type-safe local JSON database 🦉
> 
> If you know JavaScript, you know how to use @zitterorg/officiis-eveniet.
...
```js
const post = { id: 1, title: '@zitterorg/officiis-eveniet is awesome', views: 100 }
...
{
  "posts": [
    { "id": 1, "title": "@zitterorg/officiis-eveniet is awesome", "views": 100 }
  ]
}
```
...
posts.filter((post) => post.title.includes('@zitterorg/officiis-eveniet')) // Filter by title
...
```sh
npm install @zitterorg/officiis-eveniet
```
...
```js
import { JSONFilePreset } from '@zitterorg/officiis-eveniet/node'
...
You can extend @zitterorg/officiis-eveniet with Lodash (or other libraries). To be able to extend it, we're not using `JSONPreset` here. Instead, we're using lower components.

```ts
import { Low } from '@zitterorg/officiis-eveniet'
import { JSONFile } from '@zitterorg/officiis-eveniet/node'
...
```js
import { LowSync } from '@zitterorg/officiis-eveniet'
import { JSONFileSync } from '@zitterorg/officiis-eveniet/node'
...
Holds your db content. If you're using the adapters coming with @zitterorg/officiis-eveniet, it can be any type supported by [`JSON.stringify`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON/stringify).
...
```js
import { JSONFile, JSONFileSync } from '@zitterorg/officiis-eveniet/node'
...
```js
import { Memory, MemorySync } from '@zitterorg/officiis-eveniet'
...
```js
import { LocalStorage, SessionStorage } from '@zitterorg/officiis-eveniet/browser'
...
```js
import { DataFile } from '@zitterorg/officiis-eveniet/node'
...
If you've published an adapter for @zitterorg/officiis-eveniet, feel free to create a PR to add it here.
...
```js
import { Adapter, Low } from '@zitterorg/officiis-eveniet'
import { TextFile } from '@zitterorg/officiis-eveniet/node'
